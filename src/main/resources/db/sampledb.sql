...
CREATE TABLE survey (survey_id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,title VARCHAR(255),description VARCHAR(1000),order_no INTEGER,created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP)


SET SCHEMA PUBLIC

INSERT INTO survey (survey_id, title, description) VALUES (1, 'TEST', 'TEST')
